...
qract_pretty_category <- function(x, df_cat, wrap_at = 0) {
  ...
  df_look_cif_mod <- df_cat %>%
    ...
    rename(
      category_id = clinical_impact_factor_id_mod,
  ...
  df_look_sub_mod <- df_cat %>%
    ...
    rename(
      category_id = finding_sub_category_id_mod,
  ...
  df_look_st_mod <- df_cat %>%
    ...
    rename(
      category_id = finding_statement_id_mod,
  ...
  df_look_cif <- df_cat %>%
    ...
    rename(
      category_id = clinical_impact_factor_id,
      name = clinical_impact_factor
    )
  ...
  df_look_sub <- df_cat %>%
    ...
    rename(
      category_id = finding_sub_category_id,
      name = finding_sub_category
    )
  ...
  df_look_st <- df_cat %>%
    ...
    rename(
      category_id = finding_statement_id,
      name = finding_statement
    )
